...
class TwitterData:
    def parse_config(self):
        config = {}
        # from file args
        if os.path.exists('/home/hduser/Desktop/processWords/config.json'):
            with open('/home/hduser/Desktop/processWords/config.json') as f:
    ...
    def getData_tweet(self, keyword, params = {}):
        maxTweets = 50
        url = 'https://api.twitter.com/1.1/statuses/mentions_timeline.json?'
       #data = {'q':'Akil Mitchell','since':'2014-12-08','until':'2015-02-01'}
	data = {'q':'Akil Mitchell'}
