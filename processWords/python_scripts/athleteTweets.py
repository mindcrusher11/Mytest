...
import authenticate_twiter as at
...
def get_geo_location(user_id):
	user = api.get_user(user_id)
	print(user.geo_enabled)

#get_geo_location(2288591042L)

s = Stack()
s.push(at.authenticate_user())
s.push(at.authenticate_test_app())
s.push(at.authenticate_api_athlete())
s.push(at.authenticate_api_frank())
